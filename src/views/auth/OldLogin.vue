...
async function onSSOLogin() {
  isSSOSubmitting.value = true
  try {
    // Redirect to your SSO provider — adjust URL as needed
    window.location.href = '/auth/sso'
  } catch {
    error.value = 'Erreur lors de la connexion SSO.'
    isSSOSubmitting.value = false
  }
}
    ...
    <div class="right-panel">
      ...
      <div class="form-card">
        ...
        <button class="sso-btn" type="button" @click="onSSOLogin" :disabled="isSSOSubmitting">
          ...
          <!-- <svg v-else xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" class="sso-icon">
            <path fill="#EA4335" d="M24 9.5c3.5 0 6.6 1.2 9.1 3.2l6.8-6.8C35.8 2.3 30.2 0 24 0 14.6 0 6.6 5.4 2.6 13.3l7.9 6.1C12.4 13 17.8 9.5 24 9.5z"/>
            <path fill="#4285F4" d="M46.5 24.5c0-1.6-.1-3.1-.4-4.5H24v8.5h12.7c-.6 3-2.3 5.5-4.8 7.2l7.6 5.9C43.8 37.3 46.5 31.3 46.5 24.5z"/>
            <path fill="#FBBC05" d="M10.5 28.6A14.8 14.8 0 0 1 9.5 24c0-1.6.3-3.2.8-4.6l-7.9-6.1A23.9 23.9 0 0 0 0 24c0 3.9.9 7.5 2.6 10.7l7.9-6.1z"/>
            <path fill="#34A853" d="M24 48c6.2 0 11.5-2 15.3-5.5l-7.6-5.9c-2 1.4-4.6 2.2-7.7 2.2-6.2 0-11.6-3.5-13.5-9.2l-7.9 6.1C6.6 42.6 14.6 48 24 48z"/>
          </svg> -->
